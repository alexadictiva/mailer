  ...
  <main class="main1">
    <div class="wrapper1">
      <section class="introContainer">
        <img src="./assets/bgUsa.png" class="usaMap" alt="USA Map">
        <div class="introContent">
          <h1>
            QUERÉS VIVIR EN
            <span class="logoUsa"><img src="./assets/usa.png" alt="Usa logo" /></span>
          </h1>
      ...
      <section class="formContainer">
        ...
        <h3>
          Dejános tu consulta y te enviaremos la información.
        </h3>
